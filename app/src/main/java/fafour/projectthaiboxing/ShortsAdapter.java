...
public class ShortsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public ShortsAdapter(Context context, List<DataAccessories> data){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ShortsAdapter.MyHolder holder=new ShortsAdapter.MyHolder(view);
        return holder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ShortsAdapter.MyHolder myHolder= (ShortsAdapter.MyHolder) holder;
        ...
        myHolder.cvAccessories.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("stock1", current.accessoriesstock1);
                intent.putExtra("stock2", current.accessoriesstock2);
                intent.putExtra("stock3", current.accessoriesstock3);
                intent.putExtra("stock4", current.accessoriesstock4);
                intent.putExtra("stock5", current.accessoriesstock5);
                intent.putExtra("stock6", current.accessoriesstock6);

...
public class ShortsActivity extends AppCompatActivity
    ...
    private ShortsAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbar.setTitle("Shorts");
    ...
    public  void showdata(){
        ...
        String Url = connect_web_service.url+"stock_3.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            List<Integer> accessories_stock5=new ArrayList<Integer>();
                            ...
                            for(int i=0;i<jsonarray.length();i++) {
                                ...
                                accessories_stock1.add(jsonResponse.getInt("stock_xs"));
                                accessories_stock2.add(jsonResponse.getInt("stock_s"));
                                accessories_stock3.add(jsonResponse.getInt("stock_m"));
                                accessories_stock4.add(jsonResponse.getInt("stock_l"));
                                accessories_stock5.add(jsonResponse.getInt("stock_xl"));
                                accessories_stock6.add(jsonResponse.getInt("stock_xxl"));
                            ...
                            for(int count=0; count < accessories_name_item.size(); count++){
                                ...
                                accessoriesData.accessoriesstock5 = accessories_stock5.get(count);
                                accessoriesData.accessoriesstock6 = accessories_stock6.get(count);
                            ...
                            mAdapter = new ShortsAdapter(ShortsActivity.this, data1);
                            mRVList.setAdapter(mAdapter);
                            mRVList.setLayoutManager(new LinearLayoutManager(ShortsActivity.this));

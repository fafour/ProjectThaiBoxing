...
public class BoxingGlovesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public BoxingGlovesAdapter(Context context, List<DataAccessories> data){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        BoxingGlovesAdapter.MyHolder holder=new BoxingGlovesAdapter.MyHolder(view);
        return holder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        BoxingGlovesAdapter.MyHolder myHolder= (BoxingGlovesAdapter.MyHolder) holder;

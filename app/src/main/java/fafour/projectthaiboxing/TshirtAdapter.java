...
/**
 * Created by Fafour on 7/4/2560.
 */

public class TshirtAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public TshirtAdapter(Context context, List<DataAccessories> data){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        TshirtAdapter.MyHolder holder=new TshirtAdapter.MyHolder(view);
        return holder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        TshirtAdapter.MyHolder myHolder= (TshirtAdapter.MyHolder) holder;
